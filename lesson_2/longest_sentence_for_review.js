...
function getSentences(text) {
  ...
  for (let match of matches) {
    let currentSentence = text.slice(previousIndex, match.index + 1).trim();
...
function longestSentence(text) {
  ...
  console.log(sentencesWords[0].join(' '));
  console.log('');
  console.log(`The longest sentence has ${sentencesWords[0].length} words.`);
}
